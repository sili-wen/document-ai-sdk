import fs from 'fs';
import type { ResponseLike } from 'document-ai/internal/to-file';
import { toFile } from 'document-ai/core/uploads';
...
describe('missing File error message', () => {
  ...
  test('is thrown', async () => {
    const uploads = await import('document-ai/core/uploads');
    await expect(
