...
```sh
npm install git+ssh://git@github.com:sili-wen/document-ai-sdk.git
```
...
We are keen for your feedback; please open an [issue](https://www.github.com/sili-wen/document-ai-sdk/issues) with questions, bugs, or suggestions.
